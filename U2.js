...
// Function to save course selection in cookies
function saveCourseSelection(courseId) {
    var courses = getCookie("courses") ? JSON.parse(getCookie("courses")) : [];
    courses.push(courseId);
    setCookie("courses", JSON.stringify(courses), 7);
}

// Function to load course selection from cookies
function loadCourseSelection() {
    var courses = getCookie("courses") ? JSON.parse(getCookie("courses")) : [];
    // Load the courses into the cart or display them
}